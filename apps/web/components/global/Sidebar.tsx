...
// Reusable component for a list of canvas links, now styled to match the theme
...
export function Sidebar() {
    ...
    return (
        // Main sidebar container with updated styling
        <aside className="h-screen w-64 flex-col border-r border-black bg-[#F0F0F0] p-4 hidden md:flex sticky top-0">
            <div className="flex items-center gap-2 mb-8">
                <FaPhoenixFramework className="h-6 w-6" />
                <h2 className="text-lg font-black">PageSmith</h2>
            </div>
            <nav className="flex-1 space-y-4 overflow-y-auto">
                {/* Styled "New Canvas" button */}
